...
def setupSmarttFunctions(obj):
    ...
    obj.insertBacktestingOrders = insertBacktestingOrders
    obj.insertBacktestingOrdersAttributes = insertBacktestingOrdersAttributes
...
def insertBrokerageOffice(self, brokerageId = None, corporateName = None, autonomousAgentName = None, email = None, city = None, state = None, mainPhone = None, secondaryPhone = None, isAlreadyKnown = None, isAlreadyUsing = None, status = None, approvalDatetime = None):
    ...
    message += self.formatString("email", email, optional=True)
    message += self.formatString("city", city, optional=False)
    message += self.formatString("state", state, optional=False)
    message += self.formatString("main_phone", mainPhone, optional=True)
    message += self.formatString("secondary_phone", secondaryPhone, optional=True)
...
insertBacktestingOrdersAttributes = [
    "order_id"]
